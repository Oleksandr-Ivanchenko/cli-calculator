...
function CLICalculator() {
  ...
  switch (command) {
    case 'add': return calculator.add(x, y);
    case 'subtract': return calculator.subtract(x, y);
    case 'multiply': return calculator.multiply(x, y);
    case 'divide': return calculator.divide(x, y);
    default: throw new Error('Operation is not supported');
  }
}

module.exports = { CLICalculator };
